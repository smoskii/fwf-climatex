...
if wrf_model == "wrf3":
    wrf_filein = f"/Volumes/RS_backup/D03/metgrid_2023_04/WRFUVIC/wrfuvic_{domain}_2023-04-01_01:00:00"
else:
    wrf_filein = f"/Volumes/RS_backup/D03/metgrid_2023_04/WRFUVIC/wrfuvic_{domain}_2023-04-01_01:00:00"
...
wrf_ds_og = xr.open_dataset(wrf_filein, engine="netcdf4")
...
res_lookup = {"d01": "36 km", "d02": "12 km", "d03": "3 km"}
res = res_lookup.get(domain, "unknown resolution")
...
save_file = f"{wrf_model}-{domain}-tzone-{season}.png"
save_dir = Path("/Users/cpearson/Projects/fwf/data") / "images" / save_file
